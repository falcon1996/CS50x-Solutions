...
char* indexes(const char* path)
{
    ...
    strcpy(index2, path);
    strcat(index2, htmlindex);
    
    if(access(index2, F_OK) != -1)
    {
        return index2;
    }
...
const char* lookup(const char* path)
{
    ...
    if(strcasecmp(find , ".css") == 0)
    {
        return "text/css";
    }
    
    else if (strcasecmp(find , ".html") == 0)
    {
        return "text/html";
    }
    
    else if (strcasecmp(find , ".gif") == 0)
    {
        return "image/gif";
    }
    
    else if(strcasecmp(find , ".ico") == 0)
    {
        return "image/x-icon";
    }
    
    else if(strcasecmp(find , ".jpg") == 0)
    {
        return "image/jpeg";
    }
    
    else if(strcasecmp(find , ".js") == 0)
    {
        return "text/javascript";
    }
    
    else if(strcasecmp(find , ".php") == 0)
    {
        return "text/x-php";
    }
    
    else if(strcasecmp(find , ".png") == 0)
    {
        return "image/png";
    }
...
bool parse(const char* line, char* abs_path, char* query)
{
   ...
   // check if method is of type GET
    ...
    /*char* new = strchr(target, '.');
    if(strcasecmp(new,".exe") == 0)
    {
        error(501);
        return false;
    }*/
